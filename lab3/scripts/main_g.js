...
function populateListProductChoices(slct1, slct2) {
	...
	for (i = 0; i < optionArray.length; i++) {
		...
		label.appendChild(document.createTextNode(productName+"  $"+productPrice+"  Beschreibung: "+productDescription));
...
function selectedItems(){
	...
	para.innerHTML = "Sie haben ausgewählt: ";
	...
	c.appendChild(para);
	c.appendChild(document.createTextNode("Der Gesamtpreis beträgt $" + getTotalPrice(chosenProducts)));
	document.getElementById("checkoutprice").innerHTML="Sie sollten bezahlen: $"+getTotalPrice(chosenProducts);
